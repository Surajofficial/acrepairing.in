                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="assets/images/banner/led tvbanner.jpg" alt="ac mechancialbanner.jpg" class="fluid-img">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container">
    <div class="row mt-5 pt-2">
        <div class="col-sm-7 ">
            ...
            <h5 class=" text-blue">Comprehensive Led TV Repairing Course</h5>
        ...
        <div class="col-12">
            ...
            <h5 class="text-blue">Hands-On Learning Experience</h5>
