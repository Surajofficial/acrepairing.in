                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="assets/images/banner/ac mechancialbanner.jpg" alt="CCTV banner 1" class="fluid-img" style="border-bottom: 1px solid #ccc;">
            ...
            <div class="pt-4 p-4 color-light" style="background-color:#0061b4;">
                ...
                <form class="text-center" id="myform_5" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="phone" id="exampleInputPassword1" placeholder="Contact Number" oninput="javascript: if (this.value.length > 10){ this.value = this.value.slice(0, 10);}if((this.value.length < 10)){document.getElementById('mksubmit_6').disabled = true;}else{document.getElementById('mksubmit_6').disabled = false;}">
                    </div>
                    <div class="form-group">
